...
if (typeof(L.Icon.Default.imagePath) === "undefined") {
  ...
  methods.addTriangleMarkers = function(lat, lng, radius, layerId, group, options, popup) {
    var df = dataframe.create()
      .col('lat', lat)
      .col('lng', lng)
    ...
    addMarkers(this, df, group, function(df, i) {
      return L.triangleMarker([df.get(i, 'lat'), df.get(i, 'lng')], df.get(i));
    });
  };
