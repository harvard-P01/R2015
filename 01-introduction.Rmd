...
## About the slides: [display modes](http://rmarkdown.rstudio.com/ioslides_presentation_format.html)
...
- Data
- Best practices / Workflows: __reproducibility__

<img src="01_introduction/script_vs_software.png" width="700px"/>

## Reproducibility

<img src="01_introduction/reproducibility.png" width="700px"/>

## Code quality

_Poor code quality is endemic, and not just in scientific computation. It is always tempting to build something 'quick and dirty', under the assumption that it can be cleaned up later. This is especially true at the cutting edge of a field — why invest time writing beautifully engineered code from the outset, if you're not sure that what you're trying to do is even possible?_

- Science / Research
    - Open Science
- Business
    - Reliability, Reusability, Regulation
- It’s efficient!
    - No immediate reward
    - But no __technical debt__
...
- Linus Torvalds
    - MINIX and Linux
    - [BitKeeper and Git](http://www.linux.com/news/featured-blogs/185-jennifer-cloer/821541-10-years-of-git-an-interview-with-git-creator-linus-torvalds)
 
 <iframe src="http://www.linux.com/news/featured-blogs/185-jennifer-cloer/821541-10-years-of-git-an-interview-with-git-creator-linus-torvalds"></iframe>   

## Git

- Design principle: _take Concurrent Versions System (CVS) as an example of what not to do; if in doubt, make the exact opposite decision_
